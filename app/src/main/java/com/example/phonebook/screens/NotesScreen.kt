...
private fun NotesList(
    ...
    val yourMutableList: MutableList<NoteModel> = mutableListOf()
    yourMutableList.addAll(notes)
    yourMutableList.sortBy { it.title }
    LazyColumn {
        items(count = yourMutableList.size) { noteIndex ->
            val note = yourMutableList[noteIndex]
            Note(
                note = note,
